        ...
        <div id="content">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Dodaj użytkownika do bazy</h6>
                </div>
                <div class="card-body">
                    <form:form method="post" modelAttribute="user">
                        ...
                        <div class="form-group">
                            <label for="numberOfTelephone">Numer telefonu</label>
                            <form:input path="numberOfTelephone" type="text" class="form-control" id="numberOfTelephone"
                                        placeholder="podaj numer telefonu"></form:input>
                        </div>

                        <div class="form-group">
                            <label for="email">Adres email</label>
                            <form:input path="email" type="text" class="form-control" id="email"
                                        placeholder="podaj adres email"></form:input>
                        </div>

                        <div class="form-group">
                            <label for="adres">Adres</label>
                            <form:input path="adres" type="text" class="form-control" id="adres"
                                        placeholder="podaj adres"></form:input>
                        </div>
